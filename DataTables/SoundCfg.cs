...
namespace ZHSM.cfg
{
public sealed partial class SoundCfg : Luban.BeanBase
{
    public SoundCfg(JSONNode _buf) 
    {
    ...
    public static SoundCfg DeserializeSoundCfg(JSONNode _buf)
    {
        return new SoundCfg(_buf);
    }
    ...
    public const int __ID__ = 1807275253;
