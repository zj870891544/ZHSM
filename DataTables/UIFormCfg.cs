...
namespace ZHSM.cfg
{
public sealed partial class UIFormCfg : Luban.BeanBase
{
    public UIFormCfg(JSONNode _buf) 
    {
    ...
    public static UIFormCfg DeserializeUIFormCfg(JSONNode _buf)
    {
        return new UIFormCfg(_buf);
    }
    ...
    public const int __ID__ = 348509132;
