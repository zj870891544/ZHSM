...
namespace ZHSM.cfg
{
public sealed partial class UISoundCfg : Luban.BeanBase
{
    public UISoundCfg(JSONNode _buf) 
    {
    ...
    public static UISoundCfg DeserializeUISoundCfg(JSONNode _buf)
    {
        return new UISoundCfg(_buf);
    }
    ...
    public const int __ID__ = -811660407;
