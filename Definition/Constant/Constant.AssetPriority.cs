...
namespace ZHSM
{
    public static partial class Constant
    {
        ...
        public static class AssetPriority
        {
            ...
            public const int BuildingAsset = 10;
            public const int CharacterAsset = 20;
            public const int WeaponAsset = 20;
            public const int EnemyAsset = 30;
            public const int BulletAsset = 40;
